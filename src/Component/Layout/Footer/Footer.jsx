...
<p>For Customer Support please write to : customercare@atherenergy.com</p>
<p>For general inquiry please write to : info@atherenergy.com</p>
                            </div>
                    </div>
                    <div className="soical_handlers">
                            <span><Linkedin className="last_svg"/></span>
                            <span><Facebook className="last_svg"/></span>
                            <span><Insta className="last_svg"/></span>
                            <span>< Youtube className="last_svg"/></span>
                    </div>
                </div>
            </div>
        </div>
