...
function Main() {
    ...
    useLayoutEffect(() => {
        ...
        .to("#head_bottom_heading",{
          top:"-20%",
          duration:1.5
        },'a')
        .to(".center",{
          backgroundImage:"linear-gradient(90deg,rgba(0, 0, 0, 0.48), rgba(0, 0, 0, 1))",
          duration:1.5
        },'a')
        .to(".action_perform", {
          bottom:"-15%",
        ...
        .to(".para_first_center", {
            marginLeft:"10%",
            opacity:1,
            duration:3.5,
        },'b')
        .to(".para_second_center", {
            marginLeft:"10%",
            opacity:1,
            duration:3.5,
        },'b')
        .to(".center_product_price", {
            marginLeft:"10%",
            opacity:1,
            duration:3.5,
        },'b')
    ...
    <div className="main_head" ref={mn}>
        ...
        <div className="center">
          <div className="box_content">
              <span className='name_left' id="evo_left">EVO</span>
          ...
          <div className="center_main_content_left">
            ...
            <p className='para_first_center'>Teific UPI Supported Hassle Free EV Charger</p>
            <p className='para_second_center'>EVOCharger..Say goodbye to apps and payment hassles. Enjoy seamless charging, effortless transactions, and a greener journey today.</p>
            <p className='center_product_price'>₹19,999</p>
            <div className="center_button">
            <button className='center_main_button buy_button'>Add To Cart</button>
            <button className='center_main_button info_button'>Know More</button>
            </div>
          </div>
          </div>
        </div>
